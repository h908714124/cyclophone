...
final class Rankings {
   ...
   * @return the next offset or {@code 0} if there is no next offset
   */
  static int nextOffset(final int idx, int offset, final byte[] sorted) {
    if (offset >= 0) {
      int next = idx + ++offset;
      if (next >= sorted.length || sorted[next] != sorted[idx])
        if (idx == 0 || sorted[idx - 1] != sorted[idx])
   ...
   * @return the next offset or {@code 0} if there is no next offset
   */
  static int nextOffset(final int idx, int offset, final short[] sorted) {
    if (offset >= 0) {
      int next = idx + ++offset;
      if (next >= sorted.length || sorted[next] != sorted[idx])
        if (idx == 0 || sorted[idx - 1] != sorted[idx])
   ...
   * @return the next offset or {@code 0} if there is no next offset
   */
  static int nextOffset(final int idx, int offset, final float[] sorted) {
    if (offset >= 0) {
      int next = idx + ++offset;
      if (next >= sorted.length || sorted[next] != sorted[idx])
        if (idx == 0 || sorted[idx - 1] != sorted[idx])
   ...
   * @return the next offset or {@code 0} if there is no next offset
   */
  static int nextOffset(final int idx, int offset, final double[] sorted) {
    if (offset >= 0) {
      int next = idx + ++offset;
      if (next >= sorted.length || sorted[next] != sorted[idx])
        if (idx == 0 || sorted[idx - 1] != sorted[idx])
   ...
   * @return the next offset or {@code 0} if there is no next offset
   */
  static int nextOffset(final int idx, int offset, final char[] sorted) {
    if (offset >= 0) {
      int next = idx + ++offset;
      if (next >= sorted.length || sorted[next] != sorted[idx])
        if (idx == 0 || sorted[idx - 1] != sorted[idx])
   ...
   * @see #apply(int[], float[])
   */
  static int[] from(float[] a, float[] b) {
    checkEqualLength(a, b);
    int[] sort = sorting(b);
    int[] unsort = invert(sort);
   ...
   * @see #apply(int[], double[])
   */
  static int[] from(double[] a, double[] b) {
    checkEqualLength(a, b);
    int[] sort = sorting(b);
    int[] unsort = invert(sort);
   ...
   */
  static byte[] apply(int[] ranking, byte[] input) {
    checkLength(ranking.length, input.length);
   ...
   * @exception java.lang.ArrayIndexOutOfBoundsException can be thrown if the {@code ranking} argument is not a ranking
   */
  static short[] apply(int[] ranking, short[] input) {
    checkLength(ranking.length, input.length);
   ...
   * @exception java.lang.ArrayIndexOutOfBoundsException can be thrown if the {@code ranking} argument is not a ranking
   */
  static long[] apply(int[] ranking, long[] input) {
    checkLength(ranking.length, input.length);
   ...
   * @exception java.lang.ArrayIndexOutOfBoundsException can be thrown if the {@code ranking} argument is not a ranking
   */
  static float[] apply(int[] ranking, float[] input) {
    checkLength(ranking.length, input.length);
   ...
   * @exception java.lang.ArrayIndexOutOfBoundsException can be thrown if the {@code ranking} argument is not a ranking
   */
  static double[] apply(int[] ranking, double[] input) {
    checkLength(ranking.length, input.length);
   ...
   * @exception java.lang.ArrayIndexOutOfBoundsException can be thrown if the {@code ranking} argument is not a ranking
   */
  static boolean[] apply(int[] ranking, boolean[] input) {
    checkLength(ranking.length, input.length);
   ...
   * @exception java.lang.ArrayIndexOutOfBoundsException can be thrown if the {@code ranking} argument is not a ranking
   */
  static char[] apply(int[] ranking, char[] input) {
    checkLength(ranking.length, input.length);
   ...
   * @see #isValid
   */
  static boolean sorts(int[] ranking, byte[] a) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static boolean sorts(int[] ranking, short[] a) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static boolean sorts(int[] ranking, long[] a) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static boolean sorts(int[] ranking, char[] a) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static boolean sorts(int[] ranking, float[] a) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static boolean sorts(int[] ranking, double[] a) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static <E extends Comparable<E>> boolean sorts(int[] ranking, E[] a) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static <E> boolean sorts(int[] ranking, E[] a, Comparator<E> comparator) {
    if (a.length < ranking.length)
      lengthFailure();
    if (a.length < 2)
      return true;
   ...
   * @see #isValid
   */
  static <E extends Comparable<E>> boolean sorts(int[] ranking, List<E> a) {
   ...
   * @see #isValid
   */
  static <E> boolean sorts(int[] ranking, List<E> a, Comparator<E> comparator) {
    if (a.size() < ranking.length)
      lengthFailure();
    if (a.size() < 2)
      return true;
